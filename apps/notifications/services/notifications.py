...
explicit cross-app service call). The inbox row, its delivery rows and the
on_commit enqueue share one transaction (joining the caller's when there is
one) - a rolled-back write never sends.
"""
