"""Computed display columns for NotificationDelivery.
...
it adds avatar header rows and colored label badges on top of django's:
    ...
    def example_header(obj: NotificationDelivery) -> list[object]:
    ...
    def example_badge(obj: NotificationDelivery) -> str:
        return str(obj)
"""
