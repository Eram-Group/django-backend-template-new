# NotificationDelivery admin checklist
...
- [ ] inline: decided if NotificationDelivery embeds on a parent admin (fill or delete inline.py)
...
- [ ] registered import: apps.notifications/admin/__init__.py imports NotificationDeliveryAdmin
