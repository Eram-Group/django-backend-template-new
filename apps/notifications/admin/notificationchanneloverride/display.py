"""Computed display columns for NotificationChannelOverride.
...
it adds avatar header rows and colored label badges on top of django's:
    ...
    def example_header(obj: NotificationChannelOverride) -> list[object]:
    ...
    def example_badge(obj: NotificationChannelOverride) -> str:
        return str(obj)
"""
