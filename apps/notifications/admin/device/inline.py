"""Inline for embedding Device rows on a parent admin.

Decide: does Device appear inline anywhere? If yes, fill this in and add
...
class DeviceInline(BaseTabularInline):
    """Device rows under a parent's change form."""
