...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "gateway_customer_id",
                    models.CharField(
                        blank=True, max_length=255, verbose_name="gateway customer id"
                    ),
                ),
                (
                    "gateway_agreement_id",
                    models.CharField(
                        blank=True, max_length=255, verbose_name="gateway agreement id"
                    ),
                ),
                (
                    "fingerprint",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "kind",
                    models.CharField(
                        choices=[("wallet_topup", "Wallet top-up"), ("other", "Other")],
                        max_length=20,
                        verbose_name="kind",
                    ),
                ),
                ...
                (
                    "currency",
                    models.CharField(
                        choices=[("SAR", "Saudi riyal"), ("EGP", "Egyptian pound")],
                        max_length=3,
                ...
                (
                    "save_card_requested",
                    models.BooleanField(
                        default=False, verbose_name="save card requested"
                    ),
                ),
                (
                    "idempotency_key",
                ...
                (
                    "gateway_charge_id",
                    models.CharField(
                        blank=True, max_length=255, verbose_name="gateway charge id"
                    ),
                ),
                (
                ...
                (
                    "checkout_url",
                    models.URLField(
                        blank=True, max_length=500, verbose_name="checkout URL"
                    ),
                ),
                (
                    "gateway_response",
                ...
                (
                    "gateway_callback",
                    models.JSONField(
                        blank=True, null=True, verbose_name="gateway callback"
                    ),
                ),
                (
                    "paid_at",
                ...
                (
                    ...
                    models.DateTimeField(
                        ...
                        editable=False,
                        null=True,
                        verbose_name="refund attempted at",
                    ),
                ),
                (
                    "user",
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                fields=["user", "gateway"], name="payments_sa_user_id_115ea9_idx"
            ),
        ),
        ...
        migrations.AddIndex(
            model_name="payment",
            index=models.Index(
                fields=["gateway_charge_id"], name="payments_pa_gateway_334498_idx"
            ),
        ),
        migrations.AddConstraint(
            model_name="payment",
