...
Unlike simulate_payment_webhook this fabricates nothing - it drives the real
service (and the real gateway outside tests), so it doubles as an ops escape
hatch until a subscription/auto-topup caller exists.
"""
...
class Command(BaseCommand):
    ...
    def add_arguments(self, parser: CommandParser) -> None:
        ...
        parser.add_argument("--kind", default="other", help="Payment kind.")
        parser.add_argument("--description", default="", help="Payment description.")
