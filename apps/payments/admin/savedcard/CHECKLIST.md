...
- [ ] inline: decided if SavedCard embeds on a parent admin (fill or delete inline.py)
...
- [ ] registered import: apps.payments/admin/__init__.py imports SavedCardAdmin
