...
from apps.payments.admin.savedcard import change_view
from apps.payments.admin.savedcard import list_view
from apps.payments.admin.savedcard import permissions
...
class SavedCardAdmin(ExportableModelAdmin):
