"""Inline for embedding Payment rows on a parent admin.

Decide: does Payment appear inline anywhere? If yes, fill this in and add
...
class PaymentInline(BaseTabularInline):
    """Payment rows under a parent's change form."""
