...
from apps.location.admin.country import change_view
from apps.location.admin.country import list_view
from apps.location.admin.country import permissions
